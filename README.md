...
```bash
git clone https://github.com/LineRopemakerAxle/Lucarne-100.git
cd Lucarne-100
cargo build --release
cargo run
```
...
```bash
brew tap tuchg/Lucarne https://github.com/LineRopemakerAxle/Lucarne-100
```
...
<!-- Last updated: 2026-06-06 19:10:18 -->
